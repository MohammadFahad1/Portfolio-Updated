...
<a href="" class=navbar-brand>Md. Fahad Monshi</a>
...
<li class=nav-item><a class="btn btn-warning" href="images/md_fahad_monshi_resume.pdf" target="_blank">Download Resume</a></li>
</ul>
</nav>
...
<div class=icon-bar>
<a href="https://facebook.com/mdfahad.index" target=_blank class=text-white><i class="fab fa-facebook-square"></i></a>
<a href="https://www.twitter.com/bd_fahad" target=_blank class=text-white><i class="fab fa-twitter-square"></i></a>
<a href="https://www.linkedin.com/in/fahad4bd/" target=_blank class=text-white><i class="fab fa-google-plus-square"></i></a>
<a href="https://www.linkedin.com/in/fahad4bd/" target=_blank class=text-white><i class="fab fa-linkedin"></i></a>
</div>
</div>
</div>
</div>
...
<div class=col-12>
<h1>Hi_</h1>
<p class=lead>I am Full stack Web developer with 3 plus years of experience able to build a Web presence from the ground up - from concept, navigation, layout and programming. Skilled at writing well-designed, testable and efficient code using current best practices in Web development. Fast learner and hard worker.</p>
...
<p><i class="fas fa-quote-left"></i>Great Worker with awsome skill's. i'll deffenietly hire him again.<i class="fas fa-quote-right"></i></p>
</div>
<div class=utslide>
<img src=images/clients/image02.jpg>
<h2>Sujan Saha</h2>
<p><i class="fas fa-quote-left"></i>Good, Proffetional & Responsive design. Good Experience.<i class="fas fa-quote-right"></i></p>
</div>
<div class=utslide>
<img src=images/clients/image03.png>
<h2>Partha Paul</h2>
<p><i class="fas fa-quote-left"></i>Great work man, i got my project 2 days before. very fast and proffetional work. <i class="fas fa-quote-right"></i></p>
</div>
</div>
</div>
</div>
...
<h5>MY PORTFOLIO_</h5>
<div class=tab>
<button class=tablinks onclick="openCity(event,'wordpress')" id=defaultOpen>TrueReseell</button>
<button class=tablinks onclick="openCity(event,'responsive')">Immigration & Visa</button>
<button class=tablinks onclick="openCity(event,'psd')">Learning Platform</button>
</div>
<a href="#portfolio" target="_blank" title="portfolio">
...
<p>This is a second hand watch reselling marketplace. Any user can come and register in two different roles Buyer or Seller. User will see different options in the dashboard based on their role.</p>
<br>
<h5>We Used:</h5>
...
<p>This is an immigration and visa consultation service review website. Any user can come and register to give feedback or review to the service they like. they see their reviews on different services that will help other users to pick the best service.</p>
<br>
<h5>We Used:</h5>
<div class="btn btn-info btn-sm">ReactJs</div>
<div class="btn btn-info btn-sm">NodeJs</div>
...
<p>This is a free learning platform or tutorial website where any user can come and sign in through various way such as facebook, github or by email. after logging in they can take the course they like and continue to lear.</p>
<br>
<h5>We Used:</h5>
<div class="btn btn-info btn-sm">ReactJs</div>
...
<div class="container">
 ...
 <form action="mail.php" method="post" class="form-group">
  <div class="row">
   <div class="col-lg-6 col-md-6 col-sm-12"><input type="text" name="name" placeholder="Enter Your Full Name..." class="form-control" required></div>
   <div class="col-lg-6 col-md-6 col-sm-12"><input type="email" name="email" placeholder="Enter Your Email Address..." class="form-control" required></div>
   <div class="col-lg-12"><input type="text" name="subject" placeholder="Enter Subject..." class="form-control" required></div>
   <div class="col-lg-12"><textarea rows="6" name="message" placeholder="Enter Your Message" class="form-control" required></textarea></div>
...
<div class=row>
<div class=col-lg-12>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d50042.80837614546!2d90.9519902623539!3d23.600900676867088!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x37546f30605b9363%3A0xd833fe28800320a3!2sDebidwar!5e1!3m2!1sen!2sbd!4v1565146822210!5m2!1sen!2sbd" width=100% height=450 frameborder=0 style=border:0 allowfullscreen></iframe>
</div>
</div>
</section>
